...
test_builds_expected_args_defaults() {
  ...
  echo "$output" | grep -F -q "Starting telegram-bot-api (Telegram Bot API Server mock 9.5) with args:  --http-port 8081 --http-stat-port 8082 --dir /data --temp-dir /tmp --log /data/logs/telegram-bot-api.log"
